...
export function eCoachTeammateRatingFromJSON(object: any): ECoachTeammateRating {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum ECoachTeammateRating");
  }
}
...
export function ePrivateCoachingSessionStateFromJSON(object: any): EPrivateCoachingSessionState {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum EPrivateCoachingSessionState");
  }
}
...
export function ePrivateCoachingSessionMemberFlagFromJSON(object: any): EPrivateCoachingSessionMemberFlag {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum EPrivateCoachingSessionMemberFlag");
  }
}
...
export function ePlayerCoachMatchFlagFromJSON(object: any): EPlayerCoachMatchFlag {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum EPlayerCoachMatchFlag");
  }
}
...
export interface CMsgPlayerCoachMatch {
  ...
  coachedTeam?: number | undefined;
  startTime?: number | undefined;
  duration?: number | undefined;
  teammateRatings: ECoachTeammateRating[];
  coachFlags?: number | undefined;
}

export interface CMsgPrivateCoachingSessionMember {
  accountId?: number | undefined;
  memberFlags?: number | undefined;
  memberSessionRating?: ECoachTeammateRating | undefined;
}

export interface CMsgPrivateCoachingSession {
  privateCoachingSessionId?: string | undefined;
  requestedTimestamp?: number | undefined;
  requestedLanguage?: number | undefined;
  coachingSessionState?: EPrivateCoachingSessionState | undefined;
  sessionMembers: CMsgPrivateCoachingSessionMember[];
  currentLobbyId?: string | undefined;
  currentServerSteamId?: string | undefined;
  acceptedTimestamp?: number | undefined;
  completedTimestamp?: number | undefined;
}

export interface CMsgPrivateCoachingSessionStatus {
  requesterCompetitiveRankTier?: number | undefined;
  requesterGamesPlayed?: number | undefined;
}
...
export interface CMsgClientToGCRequestPlayerCoachMatchResponse {
  result?: CMsgClientToGCRequestPlayerCoachMatchResponse_EResponse | undefined;
...
export interface CMsgClientToGCSubmitCoachTeammateRating {
  ...
  rating?: ECoachTeammateRating | undefined;
  reason?: string | undefined;
}

export interface CMsgClientToGCSubmitCoachTeammateRatingResponse {
  result?: CMsgClientToGCSubmitCoachTeammateRatingResponse_EResponse | undefined;
}
...
export interface CMsgClientToGCRequestPrivateCoachingSessionResponse {
  result?: CMsgClientToGCRequestPrivateCoachingSessionResponse_EResponse | undefined;
  coachingSession?: CMsgPrivateCoachingSession | undefined;
}
...
export interface CMsgClientToGCAcceptPrivateCoachingSession {
  coachingSessionId?: string | undefined;
}

export interface CMsgClientToGCAcceptPrivateCoachingSessionResponse {
  result?: CMsgClientToGCAcceptPrivateCoachingSessionResponse_EResponse | undefined;
  coachingSession?: CMsgPrivateCoachingSession | undefined;
}
...
export interface CMsgClientToGCSubmitPrivateCoachingSessionRating {
  coachingSessionId?: string | undefined;
  sessionRating?: ECoachTeammateRating | undefined;
}

export interface CMsgClientToGCSubmitPrivateCoachingSessionRatingResponse {
  result?: CMsgClientToGCSubmitPrivateCoachingSessionRatingResponse_EResponse | undefined;
}
...
export interface CMsgClientToGCGetAvailablePrivateCoachingSessionsResponse {
  result?: CMsgClientToGCGetAvailablePrivateCoachingSessionsResponse_EResponse | undefined;
...
export interface CMsgClientToGCCoachFriendResponse {
  result?: CMsgClientToGCCoachFriendResponse_EResponse | undefined;
}
...
export interface CMsgClientToGCRespondToCoachFriendRequest {
  coachAccountId?: number | undefined;
  response?: ELobbyMemberCoachRequestState | undefined;
}

export interface CMsgClientToGCRespondToCoachFriendRequestResponse {
  result?: CMsgClientToGCRespondToCoachFriendRequestResponse_EResponse | undefined;
}
...
export const CMsgPlayerCoachMatch = {
  encode(message: CMsgPlayerCoachMatch, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.coachedTeam !== undefined && message.coachedTeam !== 0) {
    ...
    writer.ldelim();
    if (message.coachFlags !== undefined && message.coachFlags !== 0) {
  ...
  fromJSON(object: any): CMsgPlayerCoachMatch {
    return {
      ...
      coachedTeam: isSet(object.coachedTeam) ? globalThis.Number(object.coachedTeam) : 0,
      startTime: isSet(object.startTime) ? globalThis.Number(object.startTime) : 0,
      duration: isSet(object.duration) ? globalThis.Number(object.duration) : 0,
      teammateRatings: globalThis.Array.isArray(object?.teammateRatings)
        ? object.teammateRatings.map((e: any) => eCoachTeammateRatingFromJSON(e))
        : [],
      coachFlags: isSet(object.coachFlags) ? globalThis.Number(object.coachFlags) : 0,
    };
  },
  ...
  toJSON(message: CMsgPlayerCoachMatch): unknown {
    ...
    if (message.coachedTeam !== undefined && message.coachedTeam !== 0) {
      obj.coachedTeam = Math.round(message.coachedTeam);
    }
    if (message.startTime !== undefined && message.startTime !== 0) {
...
export const CMsgPrivateCoachingSessionMember = {
  encode(message: CMsgPrivateCoachingSessionMember, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.memberFlags !== undefined && message.memberFlags !== 0) {
      writer.uint32(16).uint32(message.memberFlags);
    }
    if (message.memberSessionRating !== undefined && message.memberSessionRating !== 0) {
  ...
  fromJSON(object: any): CMsgPrivateCoachingSessionMember {
    return {
      ...
      memberFlags: isSet(object.memberFlags) ? globalThis.Number(object.memberFlags) : 0,
  ...
  toJSON(message: CMsgPrivateCoachingSessionMember): unknown {
    ...
    if (message.memberFlags !== undefined && message.memberFlags !== 0) {
      obj.memberFlags = Math.round(message.memberFlags);
    }
    if (message.memberSessionRating !== undefined && message.memberSessionRating !== 0) {
...
export const CMsgPrivateCoachingSession = {
  encode(message: CMsgPrivateCoachingSession, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.privateCoachingSessionId !== undefined && message.privateCoachingSessionId !== "0") {
      writer.uint32(8).uint64(message.privateCoachingSessionId);
    }
    if (message.requestedTimestamp !== undefined && message.requestedTimestamp !== 0) {
      writer.uint32(21).fixed32(message.requestedTimestamp);
    }
    if (message.requestedLanguage !== undefined && message.requestedLanguage !== 0) {
      writer.uint32(24).uint32(message.requestedLanguage);
    }
    if (message.coachingSessionState !== undefined && message.coachingSessionState !== 0) {
    ...
    if (message.currentLobbyId !== undefined && message.currentLobbyId !== "0") {
      writer.uint32(48).uint64(message.currentLobbyId);
    }
    if (message.currentServerSteamId !== undefined && message.currentServerSteamId !== "0") {
      writer.uint32(56).uint64(message.currentServerSteamId);
    }
    if (message.acceptedTimestamp !== undefined && message.acceptedTimestamp !== 0) {
      writer.uint32(69).fixed32(message.acceptedTimestamp);
    }
    if (message.completedTimestamp !== undefined && message.completedTimestamp !== 0) {
  ...
  fromJSON(object: any): CMsgPrivateCoachingSession {
    return {
      privateCoachingSessionId: isSet(object.privateCoachingSessionId)
        ? globalThis.String(object.privateCoachingSessionId)
        : "0",
      requestedTimestamp: isSet(object.requestedTimestamp) ? globalThis.Number(object.requestedTimestamp) : 0,
      requestedLanguage: isSet(object.requestedLanguage) ? globalThis.Number(object.requestedLanguage) : 0,
      coachingSessionState: isSet(object.coachingSessionState)
        ? ePrivateCoachingSessionStateFromJSON(object.coachingSessionState)
        : 0,
      sessionMembers: globalThis.Array.isArray(object?.sessionMembers)
        ? object.sessionMembers.map((e: any) => CMsgPrivateCoachingSessionMember.fromJSON(e))
        : [],
      currentLobbyId: isSet(object.currentLobbyId) ? globalThis.String(object.currentLobbyId) : "0",
      currentServerSteamId: isSet(object.currentServerSteamId) ? globalThis.String(object.currentServerSteamId) : "0",
      acceptedTimestamp: isSet(object.acceptedTimestamp) ? globalThis.Number(object.acceptedTimestamp) : 0,
      completedTimestamp: isSet(object.completedTimestamp) ? globalThis.Number(object.completedTimestamp) : 0,
    };
  },
  ...
  toJSON(message: CMsgPrivateCoachingSession): unknown {
    const obj: any = {};
    if (message.privateCoachingSessionId !== undefined && message.privateCoachingSessionId !== "0") {
      obj.privateCoachingSessionId = message.privateCoachingSessionId;
    }
    if (message.requestedTimestamp !== undefined && message.requestedTimestamp !== 0) {
      obj.requestedTimestamp = Math.round(message.requestedTimestamp);
    }
    if (message.requestedLanguage !== undefined && message.requestedLanguage !== 0) {
      obj.requestedLanguage = Math.round(message.requestedLanguage);
    }
    if (message.coachingSessionState !== undefined && message.coachingSessionState !== 0) {
      obj.coachingSessionState = ePrivateCoachingSessionStateToJSON(message.coachingSessionState);
    }
    if (message.sessionMembers?.length) {
      obj.sessionMembers = message.sessionMembers.map((e) => CMsgPrivateCoachingSessionMember.toJSON(e));
    }
    if (message.currentLobbyId !== undefined && message.currentLobbyId !== "0") {
      obj.currentLobbyId = message.currentLobbyId;
    }
    if (message.currentServerSteamId !== undefined && message.currentServerSteamId !== "0") {
      obj.currentServerSteamId = message.currentServerSteamId;
    }
    if (message.acceptedTimestamp !== undefined && message.acceptedTimestamp !== 0) {
      obj.acceptedTimestamp = Math.round(message.acceptedTimestamp);
    }
    if (message.completedTimestamp !== undefined && message.completedTimestamp !== 0) {
      obj.completedTimestamp = Math.round(message.completedTimestamp);
    }
    return obj;
  },
...
export const CMsgPrivateCoachingSessionStatus = {
  encode(message: CMsgPrivateCoachingSessionStatus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.requesterCompetitiveRankTier !== undefined && message.requesterCompetitiveRankTier !== 0) {
      writer.uint32(8).uint32(message.requesterCompetitiveRankTier);
    }
    if (message.requesterGamesPlayed !== undefined && message.requesterGamesPlayed !== 0) {
  ...
  fromJSON(object: any): CMsgPrivateCoachingSessionStatus {
    return {
      requesterCompetitiveRankTier: isSet(object.requesterCompetitiveRankTier)
        ? globalThis.Number(object.requesterCompetitiveRankTier)
        : 0,
      requesterGamesPlayed: isSet(object.requesterGamesPlayed) ? globalThis.Number(object.requesterGamesPlayed) : 0,
    };
  },
  ...
  toJSON(message: CMsgPrivateCoachingSessionStatus): unknown {
    ...
    if (message.requesterGamesPlayed !== undefined && message.requesterGamesPlayed !== 0) {
      obj.requesterGamesPlayed = Math.round(message.requesterGamesPlayed);
    }
    return obj;
  },
...
export const CMsgAvailablePrivateCoachingSession = {
  ...
  toJSON(message: CMsgAvailablePrivateCoachingSession): unknown {
    const obj: any = {};
    if (message.coachingSession !== undefined) {
      obj.coachingSession = CMsgPrivateCoachingSession.toJSON(message.coachingSession);
    }
    if (message.coachingSessionStatus !== undefined) {
      obj.coachingSessionStatus = CMsgPrivateCoachingSessionStatus.toJSON(message.coachingSessionStatus);
    }
    return obj;
  },
...
export const CMsgAvailablePrivateCoachingSessionList = {
  ...
  fromJSON(object: any): CMsgAvailablePrivateCoachingSessionList {
    return {
      availableCoachingSessions: globalThis.Array.isArray(object?.availableCoachingSessions)
...
export const CMsgAvailablePrivateCoachingSessionSummary = {
  encode(message: CMsgAvailablePrivateCoachingSessionSummary, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.coachingSessionCount !== undefined && message.coachingSessionCount !== 0) {
  ...
  fromJSON(object: any): CMsgAvailablePrivateCoachingSessionSummary {
    return {
      coachingSessionCount: isSet(object.coachingSessionCount) ? globalThis.Number(object.coachingSessionCount) : 0,
    };
  },
  ...
  toJSON(message: CMsgAvailablePrivateCoachingSessionSummary): unknown {
    const obj: any = {};
    if (message.coachingSessionCount !== undefined && message.coachingSessionCount !== 0) {
      obj.coachingSessionCount = Math.round(message.coachingSessionCount);
    }
    return obj;
  },
...
export const CMsgClientToGCRequestPlayerCoachMatchesResponse = {
  ...
  fromJSON(object: any): CMsgClientToGCRequestPlayerCoachMatchesResponse {
    return {
      result: isSet(object.result)
        ...
        : 0,
      coachMatches: globalThis.Array.isArray(object?.coachMatches)
  ...
  toJSON(message: CMsgClientToGCRequestPlayerCoachMatchesResponse): unknown {
    ...
    if (message.coachMatches?.length) {
      obj.coachMatches = message.coachMatches.map((e) => CMsgPlayerCoachMatch.toJSON(e));
    }
    return obj;
  },
...
export const CMsgClientToGCRequestPlayerCoachMatchResponse = {
  ...
  toJSON(message: CMsgClientToGCRequestPlayerCoachMatchResponse): unknown {
    ...
    if (message.coachMatch !== undefined) {
      obj.coachMatch = CMsgPlayerCoachMatch.toJSON(message.coachMatch);
    }
    return obj;
  },
...
export const CMsgClientToGCSubmitCoachTeammateRating = {
  ...
  toJSON(message: CMsgClientToGCSubmitCoachTeammateRating): unknown {
    ...
    if (message.rating !== undefined && message.rating !== 0) {
      obj.rating = eCoachTeammateRatingToJSON(message.rating);
    }
    if (message.reason !== undefined && message.reason !== "") {
...
export const CMsgClientToGCAcceptPrivateCoachingSession = {
  encode(message: CMsgClientToGCAcceptPrivateCoachingSession, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.coachingSessionId !== undefined && message.coachingSessionId !== "0") {
  ...
  fromJSON(object: any): CMsgClientToGCAcceptPrivateCoachingSession {
    return { coachingSessionId: isSet(object.coachingSessionId) ? globalThis.String(object.coachingSessionId) : "0" };
  },

  toJSON(message: CMsgClientToGCAcceptPrivateCoachingSession): unknown {
    const obj: any = {};
    if (message.coachingSessionId !== undefined && message.coachingSessionId !== "0") {
      obj.coachingSessionId = message.coachingSessionId;
    }
    return obj;
  },
...
export const CMsgClientToGCGetCurrentPrivateCoachingSessionResponse = {
  ...
  toJSON(message: CMsgClientToGCGetCurrentPrivateCoachingSessionResponse): unknown {
    ...
    if (message.currentSession !== undefined) {
      obj.currentSession = CMsgPrivateCoachingSession.toJSON(message.currentSession);
    }
    return obj;
  },
...
export const CMsgClientToGCSubmitPrivateCoachingSessionRating = {
  encode(
    ...
    if (message.sessionRating !== undefined && message.sessionRating !== 0) {
  ...
  fromJSON(object: any): CMsgClientToGCSubmitPrivateCoachingSessionRating {
    return {
      coachingSessionId: isSet(object.coachingSessionId) ? globalThis.String(object.coachingSessionId) : "0",
  ...
  toJSON(message: CMsgClientToGCSubmitPrivateCoachingSessionRating): unknown {
    ...
    if (message.sessionRating !== undefined && message.sessionRating !== 0) {
      obj.sessionRating = eCoachTeammateRatingToJSON(message.sessionRating);
    }
    return obj;
  },
...
export const CMsgClientToGCGetAvailablePrivateCoachingSessionsResponse = {
  ...
  toJSON(message: CMsgClientToGCGetAvailablePrivateCoachingSessionsResponse): unknown {
    ...
    if (message.availableSessionsList !== undefined) {
      obj.availableSessionsList = CMsgAvailablePrivateCoachingSessionList.toJSON(message.availableSessionsList);
    }
    return obj;
  },
...
export const CMsgClientToGCGetAvailablePrivateCoachingSessionsSummaryResponse = {
  ...
  toJSON(message: CMsgClientToGCGetAvailablePrivateCoachingSessionsSummaryResponse): unknown {
    ...
    if (message.coachingSessionSummary !== undefined) {
      obj.coachingSessionSummary = CMsgAvailablePrivateCoachingSessionSummary.toJSON(message.coachingSessionSummary);
    }
    return obj;
  },
...
export const CMsgClientToGCCoachFriendResponse = {
  ...
  toJSON(message: CMsgClientToGCCoachFriendResponse): unknown {
    const obj: any = {};
    if (message.result !== undefined && message.result !== 0) {
      obj.result = cMsgClientToGCCoachFriendResponse_EResponseToJSON(message.result);
    }
    return obj;
  },
...
export const CMsgClientToGCRespondToCoachFriendRequest = {
  ...
  toJSON(message: CMsgClientToGCRespondToCoachFriendRequest): unknown {
    ...
    if (message.response !== undefined && message.response !== 0) {
      obj.response = eLobbyMemberCoachRequestStateToJSON(message.response);
    }
    return obj;
  },
