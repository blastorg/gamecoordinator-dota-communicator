...
export function eGuildEventAuditActionFromJSON(object: any): EGuildEventAuditAction {
  switch (object) {
    ...
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum EGuildEventAuditAction");
  }
}
...
export interface CMsgGuildContract {
  ...
  assignedAccountId?: number | undefined;
  contractFlags?: number | undefined;
}
...
export interface CMsgAccountGuildEventData {
  ...
  contractsRefreshedTimestamp?: number | undefined;
  contractSlots: CMsgGuildContractSlot[];
  completedChallengeCount?: number | undefined;
  challengesRefreshTimestamp?: number | undefined;
  guildWeeklyPercentile?: number | undefined;
  guildWeeklyLastTimestamp?: number | undefined;
  lastWeeklyClaimTime?: number | undefined;
...
export interface CMsgClientToGCRequestAccountGuildEventDataResponse {
  result?: CMsgClientToGCRequestAccountGuildEventDataResponse_EResponse | undefined;
  eventId?: EEvent | undefined;
...
export interface CMsgGCToClientAccountGuildEventDataUpdated {
  ...
  contractsUpdated?: boolean | undefined;
}
...
export interface CMsgClientToGCRequestActiveGuildContractsResponse {
  result?: CMsgClientToGCRequestActiveGuildContractsResponse_EResponse | undefined;
...
export interface CMsgClientToGCSelectGuildContractResponse {
  result?: CMsgClientToGCSelectGuildContractResponse_EResponse | undefined;
}
...
export interface CMsgClientToGCRequestActiveGuildChallengeResponse {
  result?: CMsgClientToGCRequestActiveGuildChallengeResponse_EResponse | undefined;
...
export interface CMsgClientToGCRequestGuildEventMembersResponse {
  result?: CMsgClientToGCRequestGuildEventMembersResponse_EResponse | undefined;
...
export interface CMsgClientToGCClaimLeaderboardRewardsResponse {
  result?: CMsgClientToGCClaimLeaderboardRewardsResponse_EResponse | undefined;
...
export const CMsgGuildContract = {
  encode(message: CMsgGuildContract, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.assignedAccountId !== undefined && message.assignedAccountId !== 0) {
      writer.uint32(40).uint32(message.assignedAccountId);
    }
    if (message.contractFlags !== undefined && message.contractFlags !== 0) {
  ...
  fromJSON(object: any): CMsgGuildContract {
    return {
      ...
      assignedAccountId: isSet(object.assignedAccountId) ? globalThis.Number(object.assignedAccountId) : 0,
      contractFlags: isSet(object.contractFlags) ? globalThis.Number(object.contractFlags) : 0,
    };
  },
  ...
  toJSON(message: CMsgGuildContract): unknown {
    ...
    if (message.assignedAccountId !== undefined && message.assignedAccountId !== 0) {
      obj.assignedAccountId = Math.round(message.assignedAccountId);
    }
    if (message.contractFlags !== undefined && message.contractFlags !== 0) {
      obj.contractFlags = Math.round(message.contractFlags);
    }
    return obj;
  },
...
export const CMsgGuildContractSlot = {
  ...
  toJSON(message: CMsgGuildContractSlot): unknown {
    const obj: any = {};
    if (message.contract !== undefined) {
      obj.contract = CMsgGuildContract.toJSON(message.contract);
    }
    return obj;
  },
...
export const CMsgAccountGuildEventData = {
  encode(message: CMsgAccountGuildEventData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.contractsRefreshedTimestamp !== undefined && message.contractsRefreshedTimestamp !== 0) {
    ...
    if (message.completedChallengeCount !== undefined && message.completedChallengeCount !== 0) {
      writer.uint32(32).uint32(message.completedChallengeCount);
    }
    if (message.challengesRefreshTimestamp !== undefined && message.challengesRefreshTimestamp !== 0) {
    ...
    if (message.guildWeeklyLastTimestamp !== undefined && message.guildWeeklyLastTimestamp !== 0) {
      writer.uint32(56).uint32(message.guildWeeklyLastTimestamp);
    }
    if (message.lastWeeklyClaimTime !== undefined && message.lastWeeklyClaimTime !== 0) {
  ...
  fromJSON(object: any): CMsgAccountGuildEventData {
    return {
      ...
      contractsRefreshedTimestamp: isSet(object.contractsRefreshedTimestamp)
        ? globalThis.Number(object.contractsRefreshedTimestamp)
        : 0,
      contractSlots: globalThis.Array.isArray(object?.contractSlots)
        ? object.contractSlots.map((e: any) => CMsgGuildContractSlot.fromJSON(e))
        : [],
      completedChallengeCount: isSet(object.completedChallengeCount)
        ? globalThis.Number(object.completedChallengeCount)
        : 0,
      challengesRefreshTimestamp: isSet(object.challengesRefreshTimestamp)
        ? globalThis.Number(object.challengesRefreshTimestamp)
        : 0,
      guildWeeklyPercentile: isSet(object.guildWeeklyPercentile) ? globalThis.Number(object.guildWeeklyPercentile) : 0,
      guildWeeklyLastTimestamp: isSet(object.guildWeeklyLastTimestamp)
        ? globalThis.Number(object.guildWeeklyLastTimestamp)
        : 0,
      lastWeeklyClaimTime: isSet(object.lastWeeklyClaimTime) ? globalThis.Number(object.lastWeeklyClaimTime) : 0,
  ...
  toJSON(message: CMsgAccountGuildEventData): unknown {
    ...
    if (message.contractSlots?.length) {
      obj.contractSlots = message.contractSlots.map((e) => CMsgGuildContractSlot.toJSON(e));
    }
    if (message.completedChallengeCount !== undefined && message.completedChallengeCount !== 0) {
    ...
    if (message.lastWeeklyClaimTime !== undefined && message.lastWeeklyClaimTime !== 0) {
      obj.lastWeeklyClaimTime = Math.round(message.lastWeeklyClaimTime);
    }
    if (message.guildCurrentPercentile !== undefined && message.guildCurrentPercentile !== 0) {
...
export const CMsgGuildActiveContracts = {
  ...
  toJSON(message: CMsgGuildActiveContracts): unknown {
    ...
    if (message.contracts?.length) {
      obj.contracts = message.contracts.map((e) => CMsgGuildContract.toJSON(e));
    }
    return obj;
  },
...
export const CMsgGuildChallenge = {
  encode(message: CMsgGuildChallenge, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.challengeProgress !== undefined && message.challengeProgress !== 0) {
  ...
  fromJSON(object: any): CMsgGuildChallenge {
    return {
      ...
      challengeParameter: isSet(object.challengeParameter) ? globalThis.Number(object.challengeParameter) : 0,
      challengeTimestamp: isSet(object.challengeTimestamp) ? globalThis.Number(object.challengeTimestamp) : 0,
      challengeProgress: isSet(object.challengeProgress) ? globalThis.Number(object.challengeProgress) : 0,
      challengeFlags: isSet(object.challengeFlags) ? globalThis.Number(object.challengeFlags) : 0,
    };
  },
  ...
  toJSON(message: CMsgGuildChallenge): unknown {
    ...
    if (message.challengeProgress !== undefined && message.challengeProgress !== 0) {
      obj.challengeProgress = Math.round(message.challengeProgress);
    }
    if (message.challengeFlags !== undefined && message.challengeFlags !== 0) {
...
export const CMsgGuildEventMember = {
  encode(message: CMsgGuildEventMember, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.guildPointsEarned !== undefined && message.guildPointsEarned !== 0) {
  ...
  fromJSON(object: any): CMsgGuildEventMember {
    return {
      ...
      guildPointsEarned: isSet(object.guildPointsEarned) ? globalThis.Number(object.guildPointsEarned) : 0,
    };
  },
  ...
  toJSON(message: CMsgGuildEventMember): unknown {
    ...
    if (message.guildPointsEarned !== undefined && message.guildPointsEarned !== 0) {
      obj.guildPointsEarned = Math.round(message.guildPointsEarned);
    }
    return obj;
  },
...
export const CMsgClientToGCRequestAccountGuildEventDataResponse = {
  ...
  toJSON(message: CMsgClientToGCRequestAccountGuildEventDataResponse): unknown {
    ...
    if (message.eventData !== undefined) {
      obj.eventData = CMsgAccountGuildEventData.toJSON(message.eventData);
    }
    return obj;
  },
...
export const CMsgGCToClientAccountGuildEventDataUpdated = {
  encode(message: CMsgGCToClientAccountGuildEventDataUpdated, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.contractsUpdated !== undefined && message.contractsUpdated !== false) {
  ...
  fromJSON(object: any): CMsgGCToClientAccountGuildEventDataUpdated {
    return {
      ...
      guildEventData: isSet(object.guildEventData)
        ...
        : undefined,
      contractsUpdated: isSet(object.contractsUpdated) ? globalThis.Boolean(object.contractsUpdated) : false,
    };
  },
  ...
  toJSON(message: CMsgGCToClientAccountGuildEventDataUpdated): unknown {
    ...
    if (message.guildEventData !== undefined) {
      obj.guildEventData = CMsgAccountGuildEventData.toJSON(message.guildEventData);
    }
    if (message.contractsUpdated !== undefined && message.contractsUpdated !== false) {
      obj.contractsUpdated = message.contractsUpdated;
    }
    return obj;
  },
  ...
  fromPartial(
    ...
    message.guildEventData =
      object.guildEventData !== undefined && object.guildEventData !== null
...
export const CMsgClientToGCRequestActiveGuildContractsResponse = {
  ...
  toJSON(message: CMsgClientToGCRequestActiveGuildContractsResponse): unknown {
    ...
    if (message.activeContracts !== undefined) {
      obj.activeContracts = CMsgGuildActiveContracts.toJSON(message.activeContracts);
    }
    if (message.activeChallenges !== undefined) {
      obj.activeChallenges = CMsgGuildChallenge.toJSON(message.activeChallenges);
    }
    return obj;
  },
  ...
  fromPartial(
    ...
    const message = createBaseCMsgClientToGCRequestActiveGuildContractsResponse();
    message.result = object.result ?? 0;
    message.activeContracts =
      object.activeContracts !== undefined && object.activeContracts !== null
        ? CMsgGuildActiveContracts.fromPartial(object.activeContracts)
        : undefined;
    message.activeChallenges =
      object.activeChallenges !== undefined && object.activeChallenges !== null
...
export const CMsgClientToGCRequestActiveGuildChallengeResponse = {
  ...
  toJSON(message: CMsgClientToGCRequestActiveGuildChallengeResponse): unknown {
    ...
    if (message.activeChallenge !== undefined) {
      obj.activeChallenge = CMsgGuildChallenge.toJSON(message.activeChallenge);
    }
    return obj;
  },
  ...
  fromPartial(
    ...
    message.activeChallenge =
      object.activeChallenge !== undefined && object.activeChallenge !== null
...
export const CMsgClientToGCRequestGuildEventMembersResponse = {
  ...
  fromJSON(object: any): CMsgClientToGCRequestGuildEventMembersResponse {
    return {
      ...
      members: globalThis.Array.isArray(object?.members)
        ? object.members.map((e: any) => CMsgGuildEventMember.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: CMsgClientToGCRequestGuildEventMembersResponse): unknown {
    ...
    if (message.members?.length) {
      obj.members = message.members.map((e) => CMsgGuildEventMember.toJSON(e));
    }
    return obj;
  },
...
export const CMsgGuildLeaderboardCombinedResponse = {
  ...
  fromJSON(object: any): CMsgGuildLeaderboardCombinedResponse {
    return {
      ...
      guildId: globalThis.Array.isArray(object?.guildId) ? object.guildId.map((e: any) => globalThis.Number(e)) : [],
      rank: globalThis.Array.isArray(object?.rank) ? object.rank.map((e: any) => globalThis.Number(e)) : [],
      currentPercentile: globalThis.Array.isArray(object?.currentPercentile)
        ? object.currentPercentile.map((e: any) => globalThis.Number(e))
        : [],
      weeklyPercentile: globalThis.Array.isArray(object?.weeklyPercentile)
        ? object.weeklyPercentile.map((e: any) => globalThis.Number(e))
        : [],
