...
export interface CSODOTAPartyMember {
  ...
  regionPingFailedBitmask?: number | undefined;
  isPlusSubscriber?: boolean | undefined;
  tourneySkillLevel?: number | undefined;
  tourneyBuyin?: number | undefined;
  tourneyPreventUntil?: number | undefined;
  mmDataValid?: boolean | undefined;
  laneSelectionFlags?: number | undefined;
  highPriorityDisabled?: boolean | undefined;
  hasHpResource?: boolean | undefined;
  joinedFromPartyfinder?: boolean | undefined;
...
export interface CSODOTAParty {
  ...
  state?: CSODOTAParty_State | undefined;
  effectiveStartedMatchmakingTime?: number | undefined;
  rawStartedMatchmakingTime?: number | undefined;
  attemptStartTime?: number | undefined;
  attemptNum?: number | undefined;
  matchgroups?: number | undefined;
  lowPriorityAccountId?: number | undefined;
  ...
  matchDisabledAccountId?: number | undefined;
  matchmakingMaxRangeMinutes?: number | undefined;
  matchlanguages?: number | undefined;
  members: CSODOTAPartyMember[];
  lowPriorityGamesRemaining?: number | undefined;
  openForJoinRequests?: boolean | undefined;
  ...
  exclusiveTournamentId?: number | undefined;
  tourneyDivisionId?: number | undefined;
  tourneyScheduleTime?: number | undefined;
  tourneySkillLevel?: number | undefined;
  tourneyBracketRound?: number | undefined;
  tourneyQueueDeadlineTime?: number | undefined;
  tourneyQueueDeadlineState?: ETourneyQueueDeadlineState | undefined;
  partyBuilderSlotsToFill?: number | undefined;
  partyBuilderMatchGroups?: number | undefined;
  partyBuilderStartTime?: number | undefined;
  ...
  customGameDisabledAccountId?: number | undefined;
  isChallengeMatch?: boolean | undefined;
  partySearchBeaconActive?: boolean | undefined;
  matchmakingFlags?: number | undefined;
  highPriorityState?: EHighPriorityMMState | undefined;
  laneSelectionsEnabled?: boolean | undefined;
  customGameDifficultyMask?: number | undefined;
  isSteamChina?: boolean | undefined;
  botDifficultyMask?: number | undefined;
  botScriptIndexMask?: number | undefined;
  restrictedFromRanked?: boolean | undefined;
  restrictedFromRankedAccountId?: number | undefined;
  rankSpreadLikertScale?: number | undefined;
  behaviorScoreLikertScale?: number | undefined;
}
...
export interface CSODOTAPartyInvite {
  ...
  teamId?: number | undefined;
  lowPriorityStatus?: boolean | undefined;
  asCoach?: boolean | undefined;
...
export interface CMsgLeaverState {
  lobbyState?: number | undefined;
  gameState?: DOTAGameState | undefined;
  leaverDetected?: boolean | undefined;
  firstBloodHappened?: boolean | undefined;
  discardMatchResults?: boolean | undefined;
...
export interface CMsgLobbyEventGameDetails {
  kvData?: Buffer | undefined;
}

export interface CMsgMatchMatchmakingStats {
  averageQueueTime?: number | undefined;
  maximumQueueTime?: number | undefined;
  behaviorScoreVariance?: EMatchBehaviorScoreVariance | undefined;
}
...
export interface CMvpData_MvpDatum_MvpAccolade {
  type?: CMvpData_MvpDatum_MvpAccolade_MvpAccoladeType | undefined;
...
export const CSODOTAPartyMember = {
  encode(message: CSODOTAPartyMember, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.isCoach !== undefined && message.isCoach !== false) {
    ...
    writer.ldelim();
    if (message.regionPingFailedBitmask !== undefined && message.regionPingFailedBitmask !== 0) {
    ...
    if (message.tourneyBuyin !== undefined && message.tourneyBuyin !== 0) {
      writer.uint32(64).uint32(message.tourneyBuyin);
    }
    if (message.tourneyPreventUntil !== undefined && message.tourneyPreventUntil !== 0) {
      writer.uint32(72).uint32(message.tourneyPreventUntil);
    }
    if (message.mmDataValid !== undefined && message.mmDataValid !== false) {
    ...
    if (message.hasHpResource !== undefined && message.hasHpResource !== false) {
      writer.uint32(120).bool(message.hasHpResource);
    }
    if (message.joinedFromPartyfinder !== undefined && message.joinedFromPartyfinder !== false) {
...
export const CSODOTAParty = {
  encode(message: CSODOTAParty, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    writer.ldelim();
    if (message.gameModes !== undefined && message.gameModes !== 0) {
      writer.uint32(32).uint32(message.gameModes);
    }
    if (message.state !== undefined && message.state !== 0) {
      writer.uint32(48).int32(message.state);
    }
    if (message.effectiveStartedMatchmakingTime !== undefined && message.effectiveStartedMatchmakingTime !== 0) {
      writer.uint32(56).uint32(message.effectiveStartedMatchmakingTime);
    }
    if (message.rawStartedMatchmakingTime !== undefined && message.rawStartedMatchmakingTime !== 0) {
      writer.uint32(256).uint32(message.rawStartedMatchmakingTime);
    }
    if (message.attemptStartTime !== undefined && message.attemptStartTime !== 0) {
      writer.uint32(264).uint32(message.attemptStartTime);
    }
    if (message.attemptNum !== undefined && message.attemptNum !== 0) {
    ...
    if (message.lowPriorityAccountId !== undefined && message.lowPriorityAccountId !== 0) {
    ...
    if (message.matchDisabledAccountId !== undefined && message.matchDisabledAccountId !== 0) {
      writer.uint32(200).uint32(message.matchDisabledAccountId);
    }
    if (message.matchmakingMaxRangeMinutes !== undefined && message.matchmakingMaxRangeMinutes !== 0) {
      writer.uint32(208).uint32(message.matchmakingMaxRangeMinutes);
    }
    if (message.matchlanguages !== undefined && message.matchlanguages !== 0) {
    ...
    if (message.openForJoinRequests !== undefined && message.openForJoinRequests !== false) {
    ...
    if (message.exclusiveTournamentId !== undefined && message.exclusiveTournamentId !== 0) {
      writer.uint32(360).uint32(message.exclusiveTournamentId);
    }
    if (message.tourneyDivisionId !== undefined && message.tourneyDivisionId !== 0) {
      writer.uint32(376).uint32(message.tourneyDivisionId);
    }
    if (message.tourneyScheduleTime !== undefined && message.tourneyScheduleTime !== 0) {
      writer.uint32(384).uint32(message.tourneyScheduleTime);
    }
    if (message.tourneySkillLevel !== undefined && message.tourneySkillLevel !== 0) {
      writer.uint32(392).uint32(message.tourneySkillLevel);
    }
    if (message.tourneyBracketRound !== undefined && message.tourneyBracketRound !== 0) {
      writer.uint32(400).uint32(message.tourneyBracketRound);
    }
    if (message.tourneyQueueDeadlineTime !== undefined && message.tourneyQueueDeadlineTime !== 0) {
      writer.uint32(432).uint32(message.tourneyQueueDeadlineTime);
    }
    if (message.tourneyQueueDeadlineState !== undefined && message.tourneyQueueDeadlineState !== 0) {
      writer.uint32(440).int32(message.tourneyQueueDeadlineState);
    }
    if (message.partyBuilderSlotsToFill !== undefined && message.partyBuilderSlotsToFill !== 0) {
      writer.uint32(448).uint32(message.partyBuilderSlotsToFill);
    }
    if (message.partyBuilderMatchGroups !== undefined && message.partyBuilderMatchGroups !== 0) {
      writer.uint32(456).uint32(message.partyBuilderMatchGroups);
    }
    if (message.partyBuilderStartTime !== undefined && message.partyBuilderStartTime !== 0) {
    ...
    if (message.customGameDisabledAccountId !== undefined && message.customGameDisabledAccountId !== 0) {
    ...
    if (message.partySearchBeaconActive !== undefined && message.partySearchBeaconActive !== false) {
      writer.uint32(528).bool(message.partySearchBeaconActive);
    }
    if (message.matchmakingFlags !== undefined && message.matchmakingFlags !== 0) {
      writer.uint32(536).uint32(message.matchmakingFlags);
    }
    if (message.highPriorityState !== undefined && message.highPriorityState !== 0) {
      writer.uint32(544).int32(message.highPriorityState);
    }
    if (message.laneSelectionsEnabled !== undefined && message.laneSelectionsEnabled !== false) {
    ...
    if (message.restrictedFromRanked !== undefined && message.restrictedFromRanked !== false) {
      writer.uint32(592).bool(message.restrictedFromRanked);
    }
    if (message.restrictedFromRankedAccountId !== undefined && message.restrictedFromRankedAccountId !== 0) {
      writer.uint32(600).uint32(message.restrictedFromRankedAccountId);
    }
    if (message.rankSpreadLikertScale !== undefined && message.rankSpreadLikertScale !== 0) {
      writer.uint32(608).uint32(message.rankSpreadLikertScale);
    }
    if (message.behaviorScoreLikertScale !== undefined && message.behaviorScoreLikertScale !== 0) {
...
export const CSODOTAPartyInvite = {
  encode(message: CSODOTAPartyInvite, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.lowPriorityStatus !== undefined && message.lowPriorityStatus !== false) {
      writer.uint32(48).bool(message.lowPriorityStatus);
    }
    if (message.asCoach !== undefined && message.asCoach !== false) {
...
export const CMsgLeaverState = {
  encode(message: CMsgLeaverState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.lobbyState !== undefined && message.lobbyState !== 0) {
    ...
    if (message.leaverDetected !== undefined && message.leaverDetected !== false) {
    ...
    if (message.discardMatchResults !== undefined && message.discardMatchResults !== false) {
...
export const CMsgReadyCheckStatus = {
  encode(message: CMsgReadyCheckStatus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.finishTimestamp !== undefined && message.finishTimestamp !== 0) {
...
export const CMsgReadyCheckStatus_ReadyMember = {
  encode(message: CMsgReadyCheckStatus_ReadyMember, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.readyStatus !== undefined && message.readyStatus !== 0) {
...
export const CMsgLobbyEventGameDetails = {
  encode(message: CMsgLobbyEventGameDetails, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.kvData !== undefined && message.kvData.length !== 0) {
...
export const CMsgMatchMatchmakingStats = {
  encode(message: CMsgMatchMatchmakingStats, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.averageQueueTime !== undefined && message.averageQueueTime !== 0) {
      writer.uint32(8).uint32(message.averageQueueTime);
    }
    if (message.maximumQueueTime !== undefined && message.maximumQueueTime !== 0) {
      writer.uint32(16).uint32(message.maximumQueueTime);
    }
    if (message.behaviorScoreVariance !== undefined && message.behaviorScoreVariance !== 0) {
...
export const CMvpData_MvpDatum_MvpAccolade = {
  encode(message: CMvpData_MvpDatum_MvpAccolade, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.detailValue !== undefined && message.detailValue !== 0) {
