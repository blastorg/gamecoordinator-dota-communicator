...
export interface CDOTAClientHardwareSpecs {
  ...
  totalPhysicalMemory?: string | undefined;
  is64BitOs?: boolean | undefined;
  uploadMeasurement?: string | undefined;
  preferNotHost?: boolean | undefined;
  crc: number[];
}

export interface CDOTASaveGame {
  matchId?: string | undefined;
  saveTime?: number | undefined;
...
export interface CMsgDOTACombatLogEntry {
  type?: dotaCombatlogTypes | undefined;
  targetName?: number | undefined;
  targetSourceName?: number | undefined;
  attackerName?: number | undefined;
  damageSourceName?: number | undefined;
  inflictorName?: number | undefined;
  isAttackerIllusion?: boolean | undefined;
  isAttackerHero?: boolean | undefined;
  isTargetIllusion?: boolean | undefined;
  isTargetHero?: boolean | undefined;
  isVisibleRadiant?: boolean | undefined;
  isVisibleDire?: boolean | undefined;
  value?: number | undefined;
  health?: number | undefined;
  timestamp?: number | undefined;
  stunDuration?: number | undefined;
  slowDuration?: number | undefined;
  isAbilityToggleOn?: boolean | undefined;
  isAbilityToggleOff?: boolean | undefined;
  abilityLevel?: number | undefined;
  locationX?: number | undefined;
  locationY?: number | undefined;
  goldReason?: number | undefined;
  timestampRaw?: number | undefined;
  modifierDuration?: number | undefined;
  xpReason?: number | undefined;
  lastHits?: number | undefined;
  attackerTeam?: number | undefined;
  targetTeam?: number | undefined;
  obsWardsPlaced?: number | undefined;
  assistPlayer0?: number | undefined;
  assistPlayer1?: number | undefined;
  assistPlayer2?: number | undefined;
  assistPlayer3?: number | undefined;
  stackCount?: number | undefined;
  hiddenModifier?: boolean | undefined;
  isTargetBuilding?: boolean | undefined;
  neutralCampType?: number | undefined;
  runeType?: number | undefined;
  assistPlayers: number[];
  isHealSave?: boolean | undefined;
  isUltimateAbility?: boolean | undefined;
  attackerHeroLevel?: number | undefined;
  targetHeroLevel?: number | undefined;
  xpm?: number | undefined;
  gpm?: number | undefined;
  eventLocation?: number | undefined;
  targetIsSelf?: boolean | undefined;
  damageType?: number | undefined;
  invisibilityModifier?: boolean | undefined;
  damageCategory?: number | undefined;
  networth?: number | undefined;
  buildingType?: number | undefined;
  modifierElapsedDuration?: number | undefined;
  silenceModifier?: boolean | undefined;
  healFromLifesteal?: boolean | undefined;
  modifierPurged?: boolean | undefined;
  spellEvaded?: boolean | undefined;
  motionControllerModifier?: boolean | undefined;
  longRangeKill?: boolean | undefined;
  modifierPurgeAbility?: number | undefined;
  modifierPurgeNpc?: number | undefined;
  rootModifier?: boolean | undefined;
  totalUnitDeathCount?: number | undefined;
  auraModifier?: boolean | undefined;
  armorDebuffModifier?: boolean | undefined;
  noPhysicalDamageModifier?: boolean | undefined;
  modifierAbility?: number | undefined;
  modifierHidden?: boolean | undefined;
  inflictorIsStolenAbility?: boolean | undefined;
  killEaterEvent?: number | undefined;
  unitStatusLabel?: number | undefined;
  spellGeneratedAttack?: boolean | undefined;
  atNightTime?: boolean | undefined;
  attackerHasScepter?: boolean | undefined;
  neutralCampTeam?: number | undefined;
...
export interface CMsgPendingEventAward {
  ...
  numToGrant?: number | undefined;
  scoreMode?: EEventActionScoreMode | undefined;
...
export const CDOTAClientHardwareSpecs = {
  encode(message: CDOTAClientHardwareSpecs, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.logicalProcessors !== undefined && message.logicalProcessors !== 0) {
      writer.uint32(8).uint32(message.logicalProcessors);
    }
    if (message.cpuCyclesPerSecond !== undefined && message.cpuCyclesPerSecond !== "0") {
      writer.uint32(17).fixed64(message.cpuCyclesPerSecond);
    }
    if (message.totalPhysicalMemory !== undefined && message.totalPhysicalMemory !== "0") {
      writer.uint32(25).fixed64(message.totalPhysicalMemory);
    }
    if (message.is64BitOs !== undefined && message.is64BitOs !== false) {
      writer.uint32(32).bool(message.is64BitOs);
    }
    if (message.uploadMeasurement !== undefined && message.uploadMeasurement !== "0") {
      writer.uint32(40).uint64(message.uploadMeasurement);
    }
    if (message.preferNotHost !== undefined && message.preferNotHost !== false) {
...
export const CDOTASaveGame = {
  encode(message: CDOTASaveGame, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.saveTime !== undefined && message.saveTime !== 0) {
...
export const CDOTASaveGame_SaveInstance = {
  encode(message: CDOTASaveGame_SaveInstance, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.team1Score !== undefined && message.team1Score !== 0) {
      writer.uint32(24).uint32(message.team1Score);
    }
    if (message.team2Score !== undefined && message.team2Score !== 0) {
...
export const CMsgDOTACombatLogEntry = {
  encode(message: CMsgDOTACombatLogEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.targetName !== undefined && message.targetName !== 0) {
      writer.uint32(16).uint32(message.targetName);
    }
    if (message.targetSourceName !== undefined && message.targetSourceName !== 0) {
      writer.uint32(24).uint32(message.targetSourceName);
    }
    if (message.attackerName !== undefined && message.attackerName !== 0) {
      writer.uint32(32).uint32(message.attackerName);
    }
    if (message.damageSourceName !== undefined && message.damageSourceName !== 0) {
      writer.uint32(40).uint32(message.damageSourceName);
    }
    if (message.inflictorName !== undefined && message.inflictorName !== 0) {
      writer.uint32(48).uint32(message.inflictorName);
    }
    if (message.isAttackerIllusion !== undefined && message.isAttackerIllusion !== false) {
      writer.uint32(56).bool(message.isAttackerIllusion);
    }
    if (message.isAttackerHero !== undefined && message.isAttackerHero !== false) {
      writer.uint32(64).bool(message.isAttackerHero);
    }
    if (message.isTargetIllusion !== undefined && message.isTargetIllusion !== false) {
      writer.uint32(72).bool(message.isTargetIllusion);
    }
    if (message.isTargetHero !== undefined && message.isTargetHero !== false) {
      writer.uint32(80).bool(message.isTargetHero);
    }
    if (message.isVisibleRadiant !== undefined && message.isVisibleRadiant !== false) {
      writer.uint32(88).bool(message.isVisibleRadiant);
    }
    if (message.isVisibleDire !== undefined && message.isVisibleDire !== false) {
    ...
    if (message.slowDuration !== undefined && message.slowDuration !== 0) {
      writer.uint32(141).float(message.slowDuration);
    }
    if (message.isAbilityToggleOn !== undefined && message.isAbilityToggleOn !== false) {
      writer.uint32(144).bool(message.isAbilityToggleOn);
    }
    if (message.isAbilityToggleOff !== undefined && message.isAbilityToggleOff !== false) {
    ...
    if (message.locationX !== undefined && message.locationX !== 0) {
      writer.uint32(173).float(message.locationX);
    }
    if (message.locationY !== undefined && message.locationY !== 0) {
      writer.uint32(181).float(message.locationY);
    }
    if (message.goldReason !== undefined && message.goldReason !== 0) {
      writer.uint32(184).uint32(message.goldReason);
    }
    if (message.timestampRaw !== undefined && message.timestampRaw !== 0) {
      writer.uint32(197).float(message.timestampRaw);
    }
    if (message.modifierDuration !== undefined && message.modifierDuration !== 0) {
      writer.uint32(205).float(message.modifierDuration);
    }
    if (message.xpReason !== undefined && message.xpReason !== 0) {
    ...
    if (message.attackerTeam !== undefined && message.attackerTeam !== 0) {
    ...
    if (message.obsWardsPlaced !== undefined && message.obsWardsPlaced !== 0) {
      writer.uint32(240).uint32(message.obsWardsPlaced);
    }
    if (message.assistPlayer0 !== undefined && message.assistPlayer0 !== 0) {
      writer.uint32(248).uint32(message.assistPlayer0);
    }
    if (message.assistPlayer1 !== undefined && message.assistPlayer1 !== 0) {
      writer.uint32(256).uint32(message.assistPlayer1);
    }
    if (message.assistPlayer2 !== undefined && message.assistPlayer2 !== 0) {
      writer.uint32(264).uint32(message.assistPlayer2);
    }
    if (message.assistPlayer3 !== undefined && message.assistPlayer3 !== 0) {
    ...
    if (message.hiddenModifier !== undefined && message.hiddenModifier !== false) {
      writer.uint32(288).bool(message.hiddenModifier);
    }
    if (message.isTargetBuilding !== undefined && message.isTargetBuilding !== false) {
      writer.uint32(296).bool(message.isTargetBuilding);
    }
    if (message.neutralCampType !== undefined && message.neutralCampType !== 0) {
      writer.uint32(304).uint32(message.neutralCampType);
    }
    if (message.runeType !== undefined && message.runeType !== 0) {
    ...
    writer.ldelim();
    if (message.isHealSave !== undefined && message.isHealSave !== false) {
      writer.uint32(328).bool(message.isHealSave);
    }
    if (message.isUltimateAbility !== undefined && message.isUltimateAbility !== false) {
      writer.uint32(336).bool(message.isUltimateAbility);
    }
    if (message.attackerHeroLevel !== undefined && message.attackerHeroLevel !== 0) {
      writer.uint32(344).uint32(message.attackerHeroLevel);
    }
    if (message.targetHeroLevel !== undefined && message.targetHeroLevel !== 0) {
    ...
    if (message.eventLocation !== undefined && message.eventLocation !== 0) {
      writer.uint32(376).uint32(message.eventLocation);
    }
    if (message.targetIsSelf !== undefined && message.targetIsSelf !== false) {
    ...
    if (message.invisibilityModifier !== undefined && message.invisibilityModifier !== false) {
      writer.uint32(400).bool(message.invisibilityModifier);
    }
    if (message.damageCategory !== undefined && message.damageCategory !== 0) {
    ...
    if (message.buildingType !== undefined && message.buildingType !== 0) {
      writer.uint32(424).uint32(message.buildingType);
    }
    if (message.modifierElapsedDuration !== undefined && message.modifierElapsedDuration !== 0) {
      writer.uint32(437).float(message.modifierElapsedDuration);
    }
    if (message.silenceModifier !== undefined && message.silenceModifier !== false) {
      writer.uint32(440).bool(message.silenceModifier);
    }
    if (message.healFromLifesteal !== undefined && message.healFromLifesteal !== false) {
      writer.uint32(448).bool(message.healFromLifesteal);
    }
    if (message.modifierPurged !== undefined && message.modifierPurged !== false) {
      writer.uint32(456).bool(message.modifierPurged);
    }
    if (message.spellEvaded !== undefined && message.spellEvaded !== false) {
      writer.uint32(464).bool(message.spellEvaded);
    }
    if (message.motionControllerModifier !== undefined && message.motionControllerModifier !== false) {
      writer.uint32(472).bool(message.motionControllerModifier);
    }
    if (message.longRangeKill !== undefined && message.longRangeKill !== false) {
      writer.uint32(480).bool(message.longRangeKill);
    }
    if (message.modifierPurgeAbility !== undefined && message.modifierPurgeAbility !== 0) {
      writer.uint32(488).uint32(message.modifierPurgeAbility);
    }
    if (message.modifierPurgeNpc !== undefined && message.modifierPurgeNpc !== 0) {
      writer.uint32(496).uint32(message.modifierPurgeNpc);
    }
    if (message.rootModifier !== undefined && message.rootModifier !== false) {
      writer.uint32(504).bool(message.rootModifier);
    }
    if (message.totalUnitDeathCount !== undefined && message.totalUnitDeathCount !== 0) {
      writer.uint32(512).uint32(message.totalUnitDeathCount);
    }
    if (message.auraModifier !== undefined && message.auraModifier !== false) {
      writer.uint32(520).bool(message.auraModifier);
    }
    if (message.armorDebuffModifier !== undefined && message.armorDebuffModifier !== false) {
      writer.uint32(528).bool(message.armorDebuffModifier);
    }
    if (message.noPhysicalDamageModifier !== undefined && message.noPhysicalDamageModifier !== false) {
      writer.uint32(536).bool(message.noPhysicalDamageModifier);
    }
    if (message.modifierAbility !== undefined && message.modifierAbility !== 0) {
      writer.uint32(544).uint32(message.modifierAbility);
    }
    if (message.modifierHidden !== undefined && message.modifierHidden !== false) {
      writer.uint32(552).bool(message.modifierHidden);
    }
    if (message.inflictorIsStolenAbility !== undefined && message.inflictorIsStolenAbility !== false) {
      writer.uint32(560).bool(message.inflictorIsStolenAbility);
    }
    if (message.killEaterEvent !== undefined && message.killEaterEvent !== 0) {
      writer.uint32(568).uint32(message.killEaterEvent);
    }
    if (message.unitStatusLabel !== undefined && message.unitStatusLabel !== 0) {
      writer.uint32(576).uint32(message.unitStatusLabel);
    }
    if (message.spellGeneratedAttack !== undefined && message.spellGeneratedAttack !== false) {
      writer.uint32(584).bool(message.spellGeneratedAttack);
    }
    if (message.atNightTime !== undefined && message.atNightTime !== false) {
      writer.uint32(592).bool(message.atNightTime);
    }
    if (message.attackerHasScepter !== undefined && message.attackerHasScepter !== false) {
      writer.uint32(600).bool(message.attackerHasScepter);
    }
    if (message.neutralCampTeam !== undefined && message.neutralCampTeam !== 0) {
      writer.uint32(608).uint32(message.neutralCampTeam);
    }
    if (message.regeneratedHealth !== undefined && message.regeneratedHealth !== 0) {
      writer.uint32(621).float(message.regeneratedHealth);
    }
    if (message.willReincarnate !== undefined && message.willReincarnate !== false) {
...
export const CMsgPendingEventAward = {
  encode(message: CMsgPendingEventAward, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.numToGrant !== undefined && message.numToGrant !== 0) {
      writer.uint32(24).uint32(message.numToGrant);
    }
    if (message.scoreMode !== undefined && message.scoreMode !== 0) {
